    ...
    function (provide, $, btr) {
        ...
        var ParseNode = function (jqueryNode) {
            ...
            function ParseClass(cls) {
                ...
                Object.keys(states).length > 0 && (obj._state = states);
                if (Boolean(elem) && Boolean(elem[0])) {
                    obj.elem = elem[0].replace(/_/g, "")
                }
                if (Boolean(view) && Boolean(view[0])) {
                ...
                $.map(item.attributes, function (attribute) {
                    switch (attribute.name) {
                        ...
                        case 'data-block':
                            break;
                        default :
                            (obj._attrs == undefined) && (obj._attrs = {});
         ...
         * @returns {Object}
         */
        var diff = function (domNode, obj1, obj2) {
            ...
            var equal = function (Node, obj1, obj2) {
                    ...
                    function replaceClass() {
                        Node.attr("class", (function () {
                            ...
                            obj2.view && (className += "_" + obj2.view);
                            obj2.elem && (className += "__" + obj2.elem);
                            obj2._state && (function () {
                    ...
                    function replaceAttrs() {
                        ...
                        for (var i = 0, length = arr.length; i < length; i++) {
                            arr[i] !== "class" && arr[i] !== "data-block" && Node.removeAttr(arr[i]);
                        }
